    ...
    >
      ...
      <div className="card-industrial rounded-xl p-4">
        <div className="flex items-center gap-2 mb-3">
          ...
          <h3 className="font-bold text-foreground">Estaciones de Forjado</h3>
        </div>
        <div className="aspect-video bg-muted rounded-lg flex items-center justify-center">
          <div className="text-center text-muted-foreground">
            <MapPin className="w-8 h-8 mx-auto mb-2 text-bronze" />
            <p className="text-sm">Mapa de ubicaciones próximamente</p>
            <p className="text-xs">Mesas de FIN en universidades</p>
          </div>
        </div>
      </div>
